...
public class Order implements Serializable{
    ...
    public Order(int idgasorder, int idgascylindertype, int idevaluategasservice, int idreceptioncentergas, String quantitygasorder, String ordergascode, String statusgasorder, float xgascoordinate, float ygascoordinate, String gasorderdate) {
